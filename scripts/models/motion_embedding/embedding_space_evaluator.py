...
from models.motion_embedding.embedding_net import EmbeddingNet, EmbeddingNetAQGT
from models.motion_embedding.motion_ae import MotionAE
...
class EmbeddingSpaceEvaluator:
    def __init__(self, args, embed_net_path, device):
    ...
    def push_samples(self, context_text, context_spec, generated_poses, real_poses):
        ...
        real_poses = real_poses.reshape(real_poses.shape[0], real_poses.shape[1], -1)
